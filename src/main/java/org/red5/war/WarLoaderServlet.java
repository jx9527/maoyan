...
public class WarLoaderServlet extends ContextLoaderListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
        	...
        	//ConfigurableBeanFactory oldFactory = applicationContext.getBeanFactory();
        	//oldFactory.destroyBean("default.context", applicationContext);
        	servletContext.removeAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE);
//         	servletContext.setInitParameter("contextConfigLocation", "classpath:defaultContext.xml");
            ...
            //factory.registerSingleton("default1.context", applicationContext);
