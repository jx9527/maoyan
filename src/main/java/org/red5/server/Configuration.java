...
import org.red5.server.jmx.JMXUtilS;
...
public final class Configuration {
	...
	private static void initSystemInfo() {
		...
		Long totalPhysicalMemorySize = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "TotalPhysicalMemorySize");
		Long totalSwapSpaceSize = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "TotalSwapSpaceSize");
		Long freePhysicalMemorySize = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "FreePhysicalMemorySize");
		Long freeSwapSpaceSize = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "FreeSwapSpaceSize");
		...
		long maxFileDescriptorCount = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "MaxFileDescriptorCount");
		...
		if (maxFileDescriptorCount > 0L) {
			long openFileDescriptorCount = JMXUtilS.getMBeanValueLong("java.lang:type=OperatingSystem", "OpenFileDescriptorCount");
	...
	private static boolean readApp(String path) {
		...
		List<String> webApps = FileUtilS.getDirectoryList(webappPath);
